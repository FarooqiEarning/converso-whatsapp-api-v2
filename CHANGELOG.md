...
* **Manager**: Update asset files and install process
  - Updated subproject reference in converso-whatsapp-api-manager-v2 to the latest commit
...
* **Kafka Migration**: Fixed PostgreSQL migration error for Kafka integration
  ...
  - Aligned table naming convention with other Converso Whatsapp Api migrations for consistency
...
* **converso-whatsapp-api Manager v2 Open Source**: converso-whatsapp-api Manager v2 is now available as open source
  - Added as git submodule with HTTPS URL for easy access
  - Complete open source setup with Apache 2.0 license + Converso Whatsapp Api custom conditions
...
* **converso-whatsapp-apiBot Enhancements**: Improved converso-whatsapp-apiBot functionality and message handling
...
* **converso-whatsapp-api Manager v2 Linting**: Resolved ESLint configuration conflicts
...
* Implement linkPreview support for converso-whatsapp-api Bot
...
* Refactor on converso-whatsapp-api Channel
...
* Add indexes to improve performance in converso-whatsapp-api
...
* Fixed use chatwoot with converso-whatsapp-api channel
* Fix chatwoot reply quote with Cloud API
* Use exchange name from .env on RabbitMQ
* Fixed chatwoot screen
* It is now possible to send images via the converso-whatsapp-api Channel
...
* converso-whatsapp-api Bot Integration
* Option to disable chatwoot bot contact with CHATWOOT_BOT_CONTACT
* Added flowise integration
* Added converso-whatsapp-api channel on instance create
...
* converso-whatsapp-apiAPI/Baileys implemented
