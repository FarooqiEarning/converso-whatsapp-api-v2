...
This file provides comprehensive guidance to Claude AI when working with the Converso Whatsapp Api codebase.

## Project Overview

**Converso Whatsapp Api** is a powerful, production-ready REST API for WhatsApp communication that supports multiple WhatsApp providers:
...
- **WhatsApp integrations**: Baileys, Meta Business API, and Converso Whatsapp Api with unified interface
...
- **converso-whatsapp-apiBot**: Native chatbot with trigger system
