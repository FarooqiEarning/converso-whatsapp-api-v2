...
const guards = [instanceExistsGuard, instanceLoggedGuard, authGuard['instanceCode']];
...
const metricsBasicAuth = (req: Request, res: Response, next: NextFunction) => {
  ...
  if (!auth || !auth.startsWith('Basic ')) {
    res.set('WWW-Authenticate', 'Basic realm="Converso Whatsapp Api Metrics"');
...
router
  ...
  .post('/verify-creds', authGuard['instanceCode'], async (req, res) => {
