  ...
  private envProcess(): Env {
    return {
      ...
      PROVIDER: {
        ...
        PREFIX: process.env?.PROVIDER_PREFIX || 'converso-whatsapp-api',
      },
      DATABASE: {
        CONNECTION: {
          URI: process.env.DATABASE_CONNECTION_URI || '',
          CLIENT_NAME: process.env.DATABASE_CONNECTION_CLIENT_NAME || 'converso-whatsapp-api',
        },
      ...
      RABBITMQ: {
        ...
        EXCHANGE_NAME: process.env?.RABBITMQ_EXCHANGE_NAME || 'converso-whatsapp-api_exchange',
      ...
      NATS: {
        ...
        EXCHANGE_NAME: process.env?.NATS_EXCHANGE_NAME || 'converso-whatsapp-api_exchange',
      ...
      KAFKA: {
        ...
        CLIENT_ID: process.env?.KAFKA_CLIENT_ID || 'converso-whatsapp-api',
        ...
        CONSUMER_GROUP_ID: process.env?.KAFKA_CONSUMER_GROUP_ID || 'converso-whatsapp-api-consumers',
        TOPIC_PREFIX: process.env?.KAFKA_TOPIC_PREFIX || 'converso-whatsapp-api',
      ...
      WA_BUSINESS: {
        TOKEN_WEBHOOK: process.env.WA_BUSINESS_TOKEN_WEBHOOK || 'converso-whatsapp-api',
      ...
      CONFIG_SESSION_PHONE: {
        CLIENT: process.env?.CONFIG_SESSION_PHONE_CLIENT || 'Converso Whatsapp Api',
      ...
      CACHE: {
        REDIS: {
          ...
          PREFIX_KEY: process.env?.CACHE_REDIS_PREFIX_KEY || 'converso-whatsapp-api-cache',
